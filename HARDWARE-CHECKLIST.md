...
working through this page: four ready to flash firmwares in
`examples/hardware-test`, a tour mode that walks every effect, and a pass or
fail row for every entry below.
