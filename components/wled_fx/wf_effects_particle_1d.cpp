...
/* Particle system 1D effects, non-audio. Needs the particle system
 * from phase P3; do not start before it lands. See BATCHES.md. */
...
#define WLED_FX_GROUP_PARTICLE_1D (WLED_FX_DEFAULT_ENABLE)
