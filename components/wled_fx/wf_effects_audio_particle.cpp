...
/* Effects that are both audio reactive and particle based. Needs
 * the particle system from phase P3. See BATCHES.md. */
...
#define WLED_FX_GROUP_AUDIO_PARTICLE (WLED_FX_DEFAULT_ENABLE)
